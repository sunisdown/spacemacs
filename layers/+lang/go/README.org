...
- Source analysis using [[http://golang.org/s/using-guru][go-guru]]
...
| Key Binding | Description                                                   |
|-------------+---------------------------------------------------------------|
| ~SPC m j <~ | go-guru show possible callers                                 |
| ~SPC m j >~ | go-guru show call targets                                     |
| ~SPC m j c~ | go-guru show channel sends/receives                           |
| ~SPC m j j~ | go-guru jump the cursor directly to that location             |
| ~SPC m j f~ | go-guru show free variables                                   |
| ~SPC m j i~ | go-guru show implements relation                              |
| ~SPC m j p~ | go-guru show variables the selected pointer may point to      |
| ~SPC m j r~ | go-guru show all refs to thing denoted by selected identifier |
| ~SPC m j s~ | go-guru callstack                                             |
| ~SPC m j d~ | go-guru describe selected syntax, kind, type and methods      |
| ~SPC m j e~ | go-guru show possible values of the selected error variable   |
